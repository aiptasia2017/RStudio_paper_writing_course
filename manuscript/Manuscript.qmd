...
mainfont: Arial
monofont: Helvetica #Times New Roman
fontsize: 11pt
linestretch: 1.2
linkcolor: blue
...
format:
  ...
  pdf:
    ...
    keep-tex: true # true: tex file is kept, false tex file is not kept (only for PDF)
    include-in-header:
      text: |
        \usepackage{lineno}
    include-before-body:
...
Test of git **show**. [@burkhardt2023] <!--# citation is wrong -->
...
```{r, out.width = "80%", fig.cap="**Figure 1. A figure** (A) A nice larva. (B) legend.  (C) <br> (D) " }
#| echo: false 
